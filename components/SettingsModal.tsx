...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose, onSettingsChanged, onDeleteAll }) => {
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] flex flex-col">
                ...
                <div className="p-6 flex-1 overflow-y-auto">
                    ...
                    <div className="mt-8 border-t border-gray-200 pt-6">
                        <h4 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Zona de Perigo</h4>
                        <button
                            onClick={() => {
