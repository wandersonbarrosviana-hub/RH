...
// ... (in component)
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose, onSettingsChanged, onClearFilters, onDeleteAll }) => {
    // ... items ...

    // (Inside Return, at the bottom of the scrollable area, before closing div)
    // ...
    // {settings.length === 0 && ( ... )}
    // </div>
    // )}
    ...
    //    <button onClick={() => { if(confirm('Tem certeza? Isso apagará TUDO!')) { onDeleteAll(); onClose(); } }} ...>
    //        Excluir Toda Base de Dados
    //    </button>
    // </div>
    // </div>
